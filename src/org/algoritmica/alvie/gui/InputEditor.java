...
public class InputEditor extends JDialog {
	...
	private class InputTable extends JPanel {
		private String[] columnNames = { "Id", "Value" };

		private Object[][] data;

		public InputTable(String[] nam, String[] val) {
...
//			table.setFillsViewportHeight(true);
	...
	public InputEditor(String title, String text, String[] nam,
			String[] val, JFrame owner) {
		super(JOptionPane.getFrameForComponent(owner), true);
		editorPane = new InputTable(nam, val);
